...
export function Computers(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <Video
        src="https://raw.githubusercontent.com/ksachikonye/hzevo-server/main/media/mp4/silent.mp4"
        frame="Object_209"
        panel="Object_210"
        y={5}
      ...
      <Video
        src="https://raw.githubusercontent.com/ksachikonye/hzevo-server/main/media/mp4/1987WACMen-100m.mp4"
        frame="Object_224"
        panel="Object_225"
...
function Video({ src, frame, panel, children, ...props }) {
  const { nodes, materials } = useGLTF('/computers_1-transformed.glb')
